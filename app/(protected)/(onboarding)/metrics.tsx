...
const metrics = () => {
  ...
  useEffect(() => {
    ...
    if (bodyFatPercentage) {
      if (bodyFatPercentage.length > 3 && !bodyFatPercentage.includes("."))
        return setValue("bodyFatPercentage", bodyFatPercentage.slice(0, 2));
      if (bodyFatPercentage.length > 4 && bodyFatPercentage.includes("."))
        return setValue("bodyFatPercentage", bodyFatPercentage.slice(0, 4));
      ...
      <ThemedView style={styles.container}>
        ...
        >
          ...
          <View style={styles.footerContainer}>
            ...
            />
            <Link
              href="/(protected)/(onboarding)/weeklyStandard"
              asChild
              onPress={handleSkipNowPressed}
            >
              <TouchableOpacity>
                <ThemedText
                  style={{
